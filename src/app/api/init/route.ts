...
const defaultContent = {
  ...
  contact: {
    ...
    socialLinks: {
      vk: "https://vk.com/witcher.roleplay.minsk",
      instagram: "https://www.instagram.com/witcher.roleplay.minsk/?next=%2F",
      telegram: "https://t.me/+SgCvIxnvgjwyMzFi",
      tiktok:
        "https://www.tiktok.com/@witcher.roleplay.minsk?_t=ZM-8vrPHrosOnu&_r=1",
    },
    mapLocation:
...
*Не экономьте на своем первом оружии, оно определит ваши первые впечатления от спорта и повлияет на формирование техники!*`,
  ...
  faq: [
    {
      question: "Какой возраст подходит для начала занятий фехтованием?",
      answer:
        "Начать заниматься фехтованием можно в любом возрасте, но оптимальным считается возраст от 8 до 12 лет. В этом возрасте дети уже достаточно координированы и способны усваивать технику фехтования. Однако у нас есть программы и для взрослых начинающих фехтовальщиков.",
    },
    {
      question: "Какое снаряжение необходимо для занятий?",
      answer:
        "Для начала занятий достаточно иметь спортивную форму и кроссовки. Все специальное снаряжение (маска, куртка, оружие) предоставляется клубом. После нескольких месяцев занятий, когда вы решите продолжать тренировки, мы поможем вам с выбором личного снаряжения.",
    },
    {
      question: "Как часто проходят тренировки?",
      answer:
        "Мы рекомендуем заниматься 2-3 раза в неделю для достижения оптимального прогресса. Однако расписание можно подстроить под ваши возможности, начав с одного занятия в неделю.",
    },
    {
      question: "Есть ли противопоказания для занятий фехтованием?",
      answer:
        "Фехтование - относительно безопасный вид спорта, но есть некоторые противопоказания: серьезные заболевания сердечно-сосудистой системы, тяжелые формы сколиоза, эпилепсия. Перед началом занятий рекомендуем проконсультироваться с врачом.",
    },
    {
      question: "Проводите ли вы индивидуальные тренировки?",
      answer:
        "Да, мы предлагаем как групповые, так и индивидуальные занятия. Индивидуальные тренировки особенно полезны для быстрого освоения техники и подготовки к соревнованиям.",
    },
  ],
};
